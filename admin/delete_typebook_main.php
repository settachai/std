...
$sql="delete from typebook where typebook_id='$_GET[typebook_id]' ";
$result=mysql_query($sql);
if($result)
{
echo "<span class='style15'>กำลังลบประเภทหนังสือเวียน</span> <br > <br >โปรดรอสักครู่<br ><img src='../images/progress_dot_line.gif' />";
echo "<script>setTimeout(\"location='view_typebook.php'\",500);</script>";
}
else
{
echo "<span class='style15'>ลบประเภทหนังสือเวียนไม่ได้</span> <br > <br ><img src='../images/progress_dot_line.gif' />";
