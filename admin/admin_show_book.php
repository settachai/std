...
$sql="select * from book , send ,send_detail , user , typebook where send.send_id = '7' and send_detail.send_id = send.send_id and send.book_id = book.book_id and send.user_id = user.user_id and book.typebook_id = typebook.typebook_id and send_detail.user_id='2' and user.user_id='1'; ";
