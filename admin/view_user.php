...
<br /><br />	</th>
  ...
  <tr bgcolor="#0099FF">
    ...
    <th width="101"><span class="style12">ชื่อ</span></th>
    <th width="111" bgcolor="#0099FF"><span class="style12">นามสกุล</span></th>
      <th width="35"><span class="style12">แสดง</span></th>
    <th width="64"><span class="style12">แก้ไข/ลบ</span></th>
  </tr> 
  <?  
...
<th> <A HREF="edit_user.php?user_id=<?=$data[user_id]?>"><img src="../images/edit.gif"  border="0"/></A>&nbsp;&nbsp;&nbsp;<A HREF="delete_user_main.php?user_id=<?=$data[user_id]?>" onclick=" return confirm
			 ('ยืนยัลบข้อมูล <?=$data[user_name] .$data[user_surname] ?>ออกจากระบบ' ) " ><img src="../images/del.gif"  border="0"/></A></tr >
