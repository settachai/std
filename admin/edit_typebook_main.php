...
<br /><br />				</th>
  ...
  <td width="562" align="center" valign="top" bgcolor="#FFFFFF" scope="col">

										<br > <br >
<?
		include "../include/connect.php";
$str="select * from typebook where typebook_name='$_POST[typebook_name]'   and typebook_id != '$_POST[typebook_id]';";
		$res=mysql_query($str);
		$rows=mysql_num_rows($res);
		$data=mysql_fetch_array($res);
		if($rows==1){	
		?>
  									<span class="style15">ประเภทนี้มีแล้วครับ ไม่สามารถแก้ไขได้</span>                                <br >
                                        <br >
                                        <img src="../images/progress_dot_line.gif" />
  <?
echo "<script>setTimeout(\"location='view_typebook.php'\",1000);</script>";	
}else{
$sql = "update typebook set typebook_name='$_POST[typebook_name]', typebook_detail='$_POST[typebook_detail]' where typebook_id='$_POST[typebook_id]' ";
$result = mysql_query($sql);  // ประมาณคำสั่ง sql ที่มาจาก $sql
if($result)
{
?>
   										<span class="style15"> แก้ไขประเภทหนังสือเวียนเรียบร้อยแล้ว</span>                       <br >         <br >โปรดรอสักครู่
                                        <br >
                                        <img src="../images/progress_dot_line.gif" />
  <?
echo "<script>setTimeout(\"location='view_typebook.php'\",1000);</script>";
...
{
?>
   										<span class="style15">ไม่สามารถแก้ไขประเภทหนังสือเวียนได้</span>                                <br >
                                        <br >
                                        <img src="../images/progress_dot_line.gif" />
  <?
