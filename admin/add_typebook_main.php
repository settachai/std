   ...
   <tr>
    ...
    <tr>
		<td width="786" height="413" align="center">
                 <table width="801" height="412"  border="0" cellpadding="0" cellspacing="0"><!-- start table 2 -->
		   <tr> 
...
$str="select * from typebook where typebook_name='$_POST[typebook_name]' or typebook_detail='$_POST[typebook_detail]' ;";
		$res=mysql_query($str);
		$rows=mysql_num_rows($res);
		if($rows==1){		
		echo "<span class='style15'>ประเภทนี้มีแล้วครับ ไม่สามารถเพิ่มซ้ำได้</span> <br > <br ><img src='../images/progress_dot_line.gif' />";
echo "<script>setTimeout(\"location='add_typebook.php'\",1000);</script>";	
}else{

$sql = " insert into typebook ( typebook_name, typebook_detail) VALUES ( '$_POST[typebook_name]', '$_POST[typebook_detail]');";
mysql_query("set names tis620"); // ทำให้อ่านภาษาไทยได้
$result = mysql_query($sql);  // ประมาณคำสั่ง sql ที่มาจาก $sql
if($result)
{
echo "<span class='style15'> กำลังเพิ่มประเภทหนังสือเวียน</span> <br > <br >โปรดรอสักครู่<br ><img src='../images/loading42.gif' />";
echo "<script>setTimeout(\"location='view_typebook.php'\",500);</script>";
}
else
{
echo "<span class='style15'> ไม่สามารถเพิ่มประเภทหนังสือเวียน</span> <br > <br >โปรดรอสักครู่<br ><img src='../images/progress_dot_line.gif' />";
echo "<script>setTimeout(\"location='add_typebook.php'\",1000);</script>";
}
}
?>
