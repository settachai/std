...
<body  bgcolor="#B4E1A8" leftmargin="0" topmargin="0" >
<br ><!-- start fieldset 3 -->
 <?
include "../include/connect.php"; 
$sql="select * from send , send_detail ,book , user , typebook where send.send_id = '$_GET[send_id]' and send_detail.send_id = send.send_id and send.book_id = book.book_id and send.user_id = user.user_id and book.typebook_id = typebook.typebook_id and send_detail.user_id='$_GET[rab]' and user.user_id='$_GET[send]'; ";
...
<table width="332" height="348" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="left">:</td>
    <?
		$sql2 = "select * from user where user_id='$_GET[rab]'  ";
 $result2 = mysql_query($sql2);  
$data2 = mysql_fetch_array($result2);
	?>
    <td align="left"><?= $data2[user_fname].'&nbsp;&nbsp;'.$data2[user_surname]?></td>
  </tr>
  <tr>
...
$file_name=$data['book_name'];
 ...
 ?>
  ...
  <tr>
    ...
    <td align="left">:</td>	
<td align="left"><a href="decode.php?name_book=<?=$file_name?>&user_send_id=<?=$data[send_id]?>" target="_blank" >
<?
if ($data[vision]==1){
echo "<font color= '#CCOOCC' >ดูไฟล์ลับ";
}
?>
</a> </td>
  </tr>
