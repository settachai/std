...
<table width="346" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2" height="128"><CENTER><img src="../pic/<?=$data[user_pic]?>" width="100" height="100"></CENTER></td>
  </tr>
  <tr>
    <td width="141" height="26"><span class="span1">USERNAME</span></td>
    <td width="96"><span class="span2"><?=$data[user_name]?></span></td>
  </tr>
  <tr>
    <td height="27"><span class="span1">PASSWORD</span></td>
    <td><span class="span2"><?=$data[user_password]?></span></td>
  </tr>
  <tr>
    <td height="26"><span class="span1">หมายเลขบัตรประชาชน</span></td>
    <td><span class="span2"><?=$data[id_card]?></span></td>
  </tr>
  <tr>
    <td height="27"><span class="span1">ชื่อ-สกุล</span></td>
    <td><span class="span2"><?=$data[user_fname]?>&nbsp;<?=$data[user_surname]?></span></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    <td height="25" valign="top"><span class="span1">รหัสเปิดไฟล์ลับ</span></td>
    <td valign="top"><span class="span2"><?=$data[user_key]?></span></td>
  </tr>
    <tr>
    <td height="25"><span class="span1">ตำแหน่ง</span></td>
    <td><span class="span2"><?=$data[position_detail]?></span></td>
  </tr>
</table>
</center>
<BR><BR>
