...
<br /><br />			</th>
     ...
     <form method=post action="add_typebook_main.php" name="form1" enctype="multipart/form-data">
                 <table width="372" height="268" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr bgcolor="#0099FF">
    <th height="60" colspan="2" bgcolor="#0099FF" scope="col"><span class="style7 style9">เพิ่มประเภทหนังสือเวียนใหม่</span><br >
      <span class="style10">(กรุณากรอกข้อมูลให้ครบทุกช่อง)</span></th>
    </tr>
  <tr>
    <th height="8" colspan="2" scope="row"><hr color="#00CCFF" size="7"></th>
    </tr>
  <tr>
    <th width="168" height="40" scope="row"><span class="style5">ชื่อประเภทหนังสือเวียน :</span> </th>
    <td width="255" align="left"> &nbsp;&nbsp;&nbsp;
      <input type="text" name="typebook_name" onkeypress="checktext()" style ="width:200px;" /></td>
  </tr>
  <tr>
    <th height="105" scope="row"><span class="style5">รายละเอียด : 	</span></th>
    <td align="left">&nbsp;&nbsp;&nbsp; <textarea name="typebook_detail" rows="5" cols="5" style ="width:200px;"></textarea></td>
  </tr>
  <tr>
    <th height="7" colspan="2" scope="row"><hr color="#00CCFF" size="5"></th>
    </tr>
  <tr>
    <th height="26" scope="row">&nbsp;</th>
    <td>&nbsp;&nbsp;&nbsp; <input type="button" value= " เพิ่ม "  onClick="checktypebook()"style = "width:80;" >&nbsp;&nbsp;<input type="reset" value="เคลียร์"></td>
  </tr>
  <tr>
    <th height="8" colspan="2" scope="row"><hr color="#00CCFF" size="5"></th>
    </tr>
</table>
     </form>
							<br ><br >  
